        ...
        <Menu 
          ...
          items={[
            ...
            isModuleEnabled('ALERT') && {
              ...
              label: '告警运维',
              children: [
                { key: '6', icon: <BellOutlined />, label: '告警中心' },
                hasPermission('admin') && { key: '17', icon: <ThunderboltOutlined />, label: '告警规则' },
            ...
            { key: '7', icon: <AreaChartOutlined />, label: '数据分析' },
            // ⚙️ 系统管理
            hasPermission('admin') && {
              key: 'system',
              ...
              label: '系统管理',
              children: [
                { key: '5', icon: <TeamOutlined />, label: '用户管理' },
                { key: '8', icon: <SettingOutlined />, label: 'License授权' },
                isModuleEnabled('AUDIT') && { key: '9', icon: <AuditOutlined />, label: '审计日志' },
                { key: '14', icon: <DashboardOutlined />, label: '系统监控' },
                { key: '22', icon: <FileTextOutlined />, label: '系统日志' },
                { key: '41', icon: <SettingOutlined />, label: '系统配置' },
                { key: '42', icon: <SafetyCertificateOutlined />, label: '安全中心' },
                { key: '21', icon: <CloudUploadOutlined />, label: '备份恢复' },
              ].filter(Boolean),
            },
            // 🔧 配置运维
            hasPermission('admin') && {
              ...
              label: '配置运维',
              children: [
                isModuleEnabled('CONFIG') && { key: '11', icon: <SettingOutlined />, label: '配置管理' },
                { key: '19', icon: <CloudServerOutlined />, label: '采集器管理' },
                { key: '20', icon: <ApiOutlined />, label: 'SNMP模板' },
                { key: '18', icon: <ScheduleOutlined />, label: '定时任务' },
                { key: '56', icon: <FileTextOutlined />, label: '设备模板' },
                { key: '24', icon: <MailOutlined />, label: '通知模板' },
                { key: '54', icon: <CloudUploadOutlined />, label: '固件升级' },
              ].filter(Boolean),
            },
            // 📈 分析报表
            hasPermission('admin') && {
              ...
              label: '分析报表',
              children: [
                isModuleEnabled('REPORT') && { key: '12', icon: <AreaChartOutlined />, label: '报表中心' },
                { key: '30', icon: <LineChartOutlined />, label: '流量分析' },
                { key: '31', icon: <DashboardOutlined />, label: '性能基线' },
                { key: '43', icon: <LineChartOutlined />, label: '性能监控' },
                { key: '48', icon: <AreaChartOutlined />, label: '容量规划' },
                { key: '27', icon: <AreaChartOutlined />, label: 'API统计' },
                { key: '57', icon: <FileSearchOutlined />, label: '日志分析' },
              ].filter(Boolean),
            },
            hasPermission('admin') && isModuleEnabled('API') && { key: '10', icon: <ApiOutlined />, label: '开放API' },
            ...
            hasPermission('admin') && {
              ...
              label: '工具运维',
              children: [
                { key: '29', icon: <CodeOutlined />, label: 'SSH管理' },
                { key: '58', icon: <ToolOutlined />, label: '网络工具' },
                { key: '65', icon: <ToolOutlined />, label: '网络诊断' },
                { key: '44', icon: <RadarChartOutlined />, label: '网络质量' },
                { key: '34', icon: <ApartmentOutlined />, label: '脚本编排' },
                { key: '68', icon: <ApartmentOutlined />, label: '工作流编排' },
              ].filter(Boolean),
            },
